  ...
  grapher.graph = function (g,d,o){
		...
		if (G) {
            ...
            if(o.gridlines){
				...
				G.innerHTML += '<div style="border-bottom:1px solid #999;position:absolute;margin-left:15px;margin-top:-' + i*20 + 'px;height:5px;width:' + c.style.width + 'px;"></div>'
			}
            }
			//plot the data
			count = 0
			if(!o.type){m("need chart type",G);return false;}
			   ...
			   count++	
				...
				G.innerHTML += '<style>body{background:#000;}</style>'
		}
  }
